...
public class ItemBuilder {
	...
	public static ItemStack ItemCreator(Material material, String name, String lore) {
		...
		/* 16 */     ItemMeta itemMeta = item.getItemMeta();
		/* 17 */     itemMeta.setDisplayName(name);
		/* 18 */     itemMeta.setLore(Arrays.asList(lore.split("\n")));
		/* 19 */     item.setItemMeta(itemMeta);
		/* 20 */     return item;
		/*    */   }
		/*    */   public static ItemStack ItemCreator(ItemStack is, String name) {
			/* 15 */     ItemMeta m = is.getItemMeta();
		...
		/* 26 */     itemMeta.setDisplayName(name);
		/* 27 */     itemMeta.setLore(Arrays.asList(lore.split("\n")));
		/* 28 */     if (enchants.containsKey(Enchantment.LURE))
		/* 29 */       itemMeta.addItemFlags(new ItemFlag[] { ItemFlag.HIDE_ENCHANTS }); 
		/* 30 */     item.setItemMeta(itemMeta);
		/* 31 */     enchants.forEach(item::addUnsafeEnchantment);
		/* 32 */     return item;
		/*    */   }
		/*    */   
		...
		/* 36 */     ItemStack item = new ItemStack(material, 1, dataID);
		/* 37 */     ItemMeta itemMeta = item.getItemMeta();
		/* 38 */     itemMeta.setDisplayName(name);
		/* 39 */     itemMeta.setLore(Arrays.asList(lore.split("\n")));
		/* 40 */     if (enchants.containsKey(Enchantment.LURE))
		/* 41 */       itemMeta.addItemFlags(new ItemFlag[] { ItemFlag.HIDE_ENCHANTS }); 
		/* 42 */     item.setItemMeta(itemMeta);
		/* 43 */     enchants.forEach(item::addUnsafeEnchantment);
		/* 44 */     return item;
		/*    */   }
		/*    */   
		/*    */   public static ItemStack ItemCreator(Material material, String name, String lore, short dataID) {
		/* 48 */     ItemStack item = new ItemStack(material, 1, dataID);
		/* 49 */     ItemMeta itemMeta = item.getItemMeta();
		/* 50 */     itemMeta.setDisplayName(name);
		/* 51 */     itemMeta.setLore(Arrays.asList(lore.split("\n")));
		/* 52 */     item.setItemMeta(itemMeta);
		/* 53 */     return item;
		/*    */   }
		/*    */   
		/*    */   public static ItemStack ItemCreator(Material material, String name, short dataID) {
		/* 57 */     ItemStack item = new ItemStack(material, 1, dataID);
		/* 58 */     ItemMeta itemMeta = item.getItemMeta();
		/* 59 */     itemMeta.setDisplayName(name);
		/* 60 */     item.setItemMeta(itemMeta);
		/* 61 */     return item;
		/*    */   }
		/*    */   
		/*    */   public static ItemStack ItemCreator(Material material, String name, short dataID, HashMap<Enchantment, Integer> enchants) {
		/* 65 */     ItemStack item = new ItemStack(material, 1, dataID);
		/* 66 */     ItemMeta itemMeta = item.getItemMeta();
		/* 67 */     itemMeta.setDisplayName(name);
		/* 68 */     if (enchants.containsKey(Enchantment.LURE))
		/* 69 */       itemMeta.addItemFlags(new ItemFlag[] { ItemFlag.HIDE_ENCHANTS }); 
		/* 70 */     item.setItemMeta(itemMeta);
		/* 71 */     enchants.forEach(item::addUnsafeEnchantment);
		/* 72 */     return item;
		/*    */   }
		/*    */   
		/*    */   public static ItemStack ItemCreator(Material material, String name) {
		/* 76 */     ItemStack item = new ItemStack(material);
		/* 77 */     ItemMeta itemMeta = item.getItemMeta();
		/* 78 */     itemMeta.setDisplayName(name);
		/* 79 */     item.setItemMeta(itemMeta);
		/* 80 */     return item;
		/*    */   }
		/*    */

		public static ItemStack ItemCreator(ItemStack itemStack, String name, String lore2,
				HashMap<Enchantment, Integer> enchant) {
