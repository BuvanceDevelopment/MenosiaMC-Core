...
import fr.buvance.menosia.utils.Utils;
import fr.buvance.menosia.utils.commands.annotations.Command;
import fr.buvance.menosia.utils.commands.annotations.Completer;
...
public class CommandFramework implements CommandExecutor {
	...
	private void defaultCommand(CommandArgs args) {
		args.getSender().sendMessage(Utils.color("&eD§sol§, la commande &6" + args.getLabel() + " n'existe pas."));
	}
}
